...
const About = () => {
  return (
    <div id='about'>
      ...
      <p className='text-center m-2 p-2 mb-6 text-black'>At Maximum Homes, we believe finding a home is more than just a transaction — it's a major life step, a fresh start, and a journey that deserves personalized attention.
      Whether you're looking to buy, sell, invest, or rent, our experienced agents guide you with care, clarity, and confidence.</p>

      <div className="carousel w-[90%] mx-auto mb-10 rounded-2xl flex justify-items-center">
